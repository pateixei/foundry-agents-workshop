...
description: Generates a Brazilian Portuguese (pt-BR) translation of documentation files, preserving technical accuracy and pedagogical tone.
---
## Mission
Produce a **complete, high-quality pt-BR translation** of documentation, ensuring technical terms, code references, and instructional tone are preserved accurately for Brazilian Portuguese-speaking audiences.
