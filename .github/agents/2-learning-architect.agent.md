...
Content deliverables at **project root**:
- **WORKSHOP-MASTER-AGENDA.md**: Detailed agenda (minute by minute or 30–60 min blocks)
- **INSTRUCTOR-GUIDE.md**: Facilitation guide for instructors — **must include a dedicated section with links to every script in `instructional-scripts/`** so the instructor can navigate directly to the detailed facilitation script for each module:
  - `instructional-scripts/MODULE-0-INFRASTRUCTURE-SCRIPT.md`
  - `instructional-scripts/MODULE-1-DECLARATIVE-AGENT-SCRIPT.md`
  - `instructional-scripts/MODULE-2-HOSTED-MAF-SCRIPT.md`
  - `instructional-scripts/MODULE-3-HOSTED-LANGGRAPH-SCRIPT.md`
  - `instructional-scripts/MODULE-4-ACA-DEPLOYMENT-SCRIPT.md`
  - `instructional-scripts/MODULES-5-6-A365-SETUP-SDK-SCRIPT.md`
  - `instructional-scripts/MODULES-7-8-PUBLISH-INSTANCES-SCRIPT.md`
