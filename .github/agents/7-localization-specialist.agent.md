...
# Localization Specialist (Agent 7)
...
Translated files live **alongside their originals** with a `.pt-BR.md` suffix (no separate folder). Examples: 

- **`README.pt-BR.md`** — Translated repository README (next to `README.md`)
- **`prereq/README.pt-BR.md`** — Translated prereq guide
- **`lesson-{1-N}/README.pt-BR.md`** — Translated lesson READMEs
