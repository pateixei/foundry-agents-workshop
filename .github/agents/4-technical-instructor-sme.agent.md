...
# Technical Instructor / Subject Matter Expert (SME) (Agent 4)
...
- Didactic guidelines created by Instructional Designer and stored at `instructor-guide/` (i.e. MODULE*.md files).
...
## Interfaces
- **Technical Reviewer (Agent 5)**: validates standards, risks, and quality.
