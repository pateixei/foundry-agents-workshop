...
- **instructor-guide/ROOM-READY-CHECKLIST.md**: "Room ready" checklist (in-person/online)
- **instructor-guide/CONTINGENCY-PLAN.md**: Contingency plan for offline/network issues

Process/tracking artifact in **`.workshop/`**:
- **`.workshop/DISTRIBUTION-MANIFEST.md`**: Version control and distribution tracking

Student kit is created at the **project root** (`student-kit/`). Instructor support files (checklists, contingency plan) go in **`instructor-guide/`**.
