...
- **Código do Agente:** `lesson-6-a365-sdk/main.py`
- **Requisitos:** `lesson-6-a365-sdk/requirements.txt`
...
- [Lição 6: Integração com SDK A365](../lesson-6-a365-sdk/README.pt-BR.md)
