...
O pacote `azure-ai-agentserver-core` v1.0.0b10 não aceita o campo `id` que o Foundry envia em `AgentReference`. Você precisa fazer patch em `_deserialize_agent_reference` para ignorar campos extras — como implementado em [main.py](lesson-3-hosted-langgraph/langgraph-agent/main.py#L211-L245).
