...
editados diretamente no portal do Foundry sem necessidade de container.

Uso:
    python create_agent.py
    python create_agent.py --name fin-market-declarative --model gpt-4.1

Requer: pip install -r requirements.txt
Ref: https://learn.microsoft.com/azure/ai-foundry/quickstarts/get-started-code
"""
...
def main():
    ...
    parser.add_argument(
        "--name", default=DEFAULT_AGENT_NAME, help="Nome do agente"
    )
    parser.add_argument(
        "--model", default=DEFAULT_MODEL, help="Model deployment name"
    )
