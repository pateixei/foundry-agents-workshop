...
Navigate to lesson 6 directory and create the file:
...
```powershell
# Execute the complete setup (inside lesson-6-a365-prereq/)
a365 setup all
```
...
|----------|-------------|-----------|
| `a365.config.json` | `lesson-6-a365-prereq/` | Manual configuration (created by hand, no wizard) |
| `a365.generated.config.json` | `lesson-6-a365-prereq/` | Configuration generated by CLI (IDs, secrets, publish details) |
